        ...
        if (!localData) {
            const demoMap = {
                'tenant-1': [
                    ...
                    { id: 'IT-002', description: 'Tienda en Línea E-commerce', price: 25000, satProduct: '81111500', satUnit: 'E48', taxRate: '16', tenantId: 'tenant-1' },
                    { id: 'IT-003', description: 'Gestión de Redes Sociales (Mensual)', price: 4500, satProduct: '82101500', satUnit: 'E48', taxRate: '16', tenantId: 'tenant-1' },
                    { id: 'IT-004', description: 'Publicidad Digital (Google/Meta Ads)', price: 3000, satProduct: '82101600', satUnit: 'E48', taxRate: '16', tenantId: 'tenant-1' },
                    { id: 'IT-005', description: 'Consultoría en Transformación Digital', price: 1500, satProduct: '81111508', satUnit: 'E48', taxRate: '16', tenantId: 'tenant-1' },
                    { id: 'IT-006', description: 'Hosting y Dominio Anual', price: 2200, satProduct: '81112105', satUnit: 'E48', taxRate: '16', tenantId: 'tenant-1' }
                ],
                'tenant-2': [
                    { id: 'SPA-001', description: 'Aplicación de Uñas Acrílicas', price: 450, satProduct: '53131600', satUnit: 'ACT', taxRate: '16', tenantId: 'tenant-2' },
                    { id: 'SPA-002', description: 'Retoque de Acrílico', price: 250, satProduct: '53131600', satUnit: 'ACT', taxRate: '16', tenantId: 'tenant-2' },
                    { id: 'SPA-003', description: 'Diseño de Uñas (Nail Art)', price: 150, satProduct: '53131600', satUnit: 'ACT', taxRate: '16', tenantId: 'tenant-2' },
                    { id: 'SPA-004', description: 'Retiro de Gelish / Acrílico', price: 100, satProduct: '53131600', satUnit: 'ACT', taxRate: '16', tenantId: 'tenant-2' },
                    { id: 'SPA-005', description: 'Manicura Rusa', price: 350, satProduct: '53131600', satUnit: 'ACT', taxRate: '16', tenantId: 'tenant-2' },
                    { id: 'SPA-006', description: 'Pedicura Spa Profunda', price: 600, satProduct: '53131600', satUnit: 'ACT', taxRate: '16', tenantId: 'tenant-2' }
                ],
                'tenant-3': [
                    { id: 'CAN-001', description: 'Puerta de Aluminio Linea Panorama', price: 4500, satProduct: '30171500', satUnit: 'H87', taxRate: '16', tenantId: 'tenant-3' },
                    { id: 'CAN-002', description: 'Barandal de Cristal Templado (Metro lineal)', price: 2800, satProduct: '30171500', satUnit: 'MTR', taxRate: '16', tenantId: 'tenant-3' },
                    { id: 'CAN-003', description: 'Domo de Cristal INOX', price: 8500, satProduct: '30171500', satUnit: 'H87', taxRate: '16', tenantId: 'tenant-3' },
                    { id: 'CAN-004', description: 'Mosquitero Corredizo', price: 850, satProduct: '30171500', satUnit: 'H87', taxRate: '16', tenantId: 'tenant-3' },
                    { id: 'CAN-005', description: 'Mantenimiento a Canceles', price: 1200, satProduct: '72101500', satUnit: 'E48', taxRate: '16', tenantId: 'tenant-3' },
                    { id: 'CAN-006', description: 'Espejo Biselado a Medida', price: 1500, satProduct: '30171500', satUnit: 'H87', taxRate: '16', tenantId: 'tenant-3' }
                ]
            };
            localItems = demoMap[currentTenant?.id] || [];
            localStorage.setItem(`inventory_${currentTenant.id}`, JSON.stringify(localItems));
        } else {
