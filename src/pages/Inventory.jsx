    ...
    const fetchProducts = async () => {
      ...
      try {
        ...
        if (combined.length === 0) {
            const demoMap = {
                'tenant-1': [
                    { id: 'IT-001', description: 'Desarrollo de Software a Medida', price: 15400, satProduct: '81111500', satUnit: 'E48', taxRate: '16' },
                    { id: 'IT-002', description: 'Mantenimiento de Servidores Cloud', price: 2500, satProduct: '81111800', satUnit: 'E48', taxRate: '16' }
                ],
                'tenant-2': [
                    { id: 'SPA-001', description: 'Manicura Spa con Gelish', price: 450, satProduct: '53131600', satUnit: 'ACT', taxRate: '16' },
                    { id: 'SPA-002', description: 'Pedicura Profunda y Esmaltado', price: 600, satProduct: '53131600', satUnit: 'ACT', taxRate: '16' }
                ],
                'tenant-3': [
                    { id: 'CAN-001', description: 'Ventana de Aluminio 2" Blanca', price: 1800, satProduct: '30171500', satUnit: 'H87', taxRate: '16' },
                    { id: 'CAN-002', description: 'Cancel de Baño Vidrio Templado', price: 6500, satProduct: '30171500', satUnit: 'H87', taxRate: '16' }
                ]
            };
